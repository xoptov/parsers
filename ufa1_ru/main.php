...
define('SITE_DOMINE', 'ufa1.ru');
define('SITE_CHARSET', 'cp1251');
define('PAGELINK_REGEXP', '/http:\/\/ufa1\.ru\/job\/vacancy\/[0-9]+\.php\?Search=2&.+/iuU');
define('JOBLINK_REGEXP', '/http:\/\/ufa1\.ru\/job\/vacancy\/([0-9]+)\.html/iu');
define('HTTP_GZIP', 1);
define('DEBUG_MODE', 1);
...
$parser = new ParserV2("http://ufa1.ru/job/vacancy/1.php?Search=2&Country=0010010000000000000000&CityCode=0010010020010010000000&Area=0&BranchID=7&Position=&Period=4&SalaryMin=&SalaryForm=0&WorkSchedule=0&Education=0&Sex=0&Stage=0&Query=1%F1");
$parser->start();
