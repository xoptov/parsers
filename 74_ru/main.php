...
define('SITE_DOMINE', '74.ru');
define('SITE_CHARSET', 'cp1251');
define('JOBLINK_REGEXP', '/http:\/\/74\.ru\/job\/vacancy\/([0-9]+)\.html/iu');
define('HTTP_GZIP', 1);

/* Константы для объявлений о ваканиях */
define('CUSTOMER_ID', 129);
...
$parser = new ParserV2("http://74.ru/job/vacancy/1.php?Search=2&Country=0010010000000000000000&CityCode=0010010220000010000000&Area=0&BranchID=7&Position=&Period=2&SalaryMin=&SalaryForm=0&WorkSchedule=0&Education=0&Sex=0&Stage=0&Query=1%F1");
$parser->start();
