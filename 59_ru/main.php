...
define('SITE_DOMINE', '59.ru');
define('SITE_CHARSET', 'cp1251');
define('PAGELINK_REGEXP', '/http:\/\/59\.ru\/job\/vacancy\/[0-9]+\.php\?Search=2&.+/iuU');
define('JOBLINK_REGEXP', '/http:\/\/59\.ru\/job\/vacancy\/([0-9]+)\.html/iu');
define('HTTP_GZIP', 1);
define('DEBUG_MODE', 1);
...
$parser = new ParserV2("http://59.ru/job/vacancy/1.php?Search=2&Country=0010010000000000000000&CityCode=00100101n0000010000000&Area=0&BranchID=7&Position=&Period=0&SalaryMin=&SalaryForm=0&WorkSchedule=0&Education=0&Sex=0&Stage=0&Query=1%F1#1.php%%Search=2&CityCode=00100101n0000010000000&Area=0&Type=vacancy&BranchID=7&Period=0&SalaryMin=0&SalaryMax=0&SalaryType=0&SalaryForm=0&AgeMin=0&AgeMax=0&AgeType=0&WorkSchedule=0&Education=0&Stage=0&Sex=0&Car=0&new_only=0&Firm=&Position=&Query=1%F1&order=DateUpdate&dir=desc");
$parser->start();
