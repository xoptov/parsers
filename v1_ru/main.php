...
define('SITE_DOMINE', 'v1.ru');
define('SITE_CHARSET', 'cp1251');
define('JOBLINK_REGEXP', '/http:\/\/v1\.ru\/job\/vacancy\/([0-9]+)\.html/iu');
define('HTTP_GZIP', 1);

/* Константы для объявлений о ваканиях */
define('CUSTOMER_ID', 8261);
...
$parser = new ParserV2("http://v1.ru/job/vacancy/1.php?Search=2&Country=0010010000000000000000&CityCode=00100100y0000010000000&Area=0&BranchID=7&Query=1%F1");
$parser->start();
