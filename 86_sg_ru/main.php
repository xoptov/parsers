...
define('SITE_DOMINE', '86.ru');
define('SITE_CHARSET', 'cp1251');
define('JOBLINK_REGEXP', '/http:\/\/86\.ru\/job\/vacancy\/([0-9]+)\.html/iu');
define('HTTP_GZIP', 1);

/* Константы для объявлений о ваканиях */
define('CUSTOMER_ID', 8252);
...
$parser = new ParserV2("http://86.ru/job/vacancy/1.php?Search=2&Country=0010010000000000000000&CityCode=00100102e00000a0000000&Area=0&BranchID=7&Position=&Period=0&SalaryMin=&SalaryForm=0&WorkSchedule=0&Education=0&Sex=0&Stage=0&Query=1%F1");
$parser->start();
