...
define('PAGELINK_REGEXP', '/http:\/\/48\.ru\/job\/vacancy\/[0-9]+\.php\?Search=2&.+/iuU');
...
$parser = new ParserV2("http://48.ru/job/vacancy/1.php?Search=2&Country=0010010000000000000000&CityCode=00100101c0000010000000&Area=0&BranchID=7&Position=&Period=0&SalaryMin=&SalaryForm=0&WorkSchedule=0&Education=0&Sex=0&Stage=0&Query=1%F1");
$parser->start();
