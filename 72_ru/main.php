...
define('SITE_DOMINE', '72.ru');
define('SITE_CHARSET', 'cp1251');
define('JOBLINK_REGEXP', '/http:\/\/72\.ru\/job\/vacancy\/([0-9]+)\.html/iu');
define('HTTP_GZIP', 1);

/* Константы для объявлений о ваканиях */
define('CUSTOMER_ID', 124);
...
$parser = new ParserV2("http://72.ru/job/vacancy/1.php?Search=2&Country=0010010000000000000000&CityCode=00100100y0000010000000&Area=0&BranchID=7&Query=1%F1");
$parser->start();
