...
define('SITE_DOMINE', '63.ru');
define('SITE_CHARSET', 'cp1251');
define('PAGELINK_REGEXP', '/http:\/\/63\.ru\/job\/vacancy\/[0-9]+\.php\?Search=2&.+/iuU');
define('JOBLINK_REGEXP', '/http:\/\/63\.ru\/job\/vacancy\/([0-9]+)\.html/iu');
define('HTTP_GZIP', 1);
define('DEBUG_MODE', 1);
...
define('FA_EMPLOY_TYPE', '/Тип\sработы<\/td>\s*<td>\s*([а-яё\s\-]+)/iu');
...
$parser = new ParserV2("http://63.ru/job/vacancy/1.php?Search=2&Country=0010010000000000000000&CityCode=00100101r0000010000000&Area=0&BranchID=7&Position=&Period=3&SalaryMin=&SalaryForm=0&WorkSchedule=0&Education=0&Sex=0&Stage=0&Query=1%F1");
$parser->start();
